...
public abstract class Hilt_WikiFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((WikiFragment_GeneratedInjector) this.generatedComponent()).injectWikiFragment(UnsafeCasts.<WikiFragment>unsafeCast(this));
    }
  }
