...
public abstract class Hilt_GuideFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((GuideFragment_GeneratedInjector) this.generatedComponent()).injectGuideFragment(UnsafeCasts.<GuideFragment>unsafeCast(this));
    }
  }
