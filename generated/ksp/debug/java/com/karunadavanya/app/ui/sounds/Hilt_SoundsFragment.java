...
public abstract class Hilt_SoundsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SoundsFragment_GeneratedInjector) this.generatedComponent()).injectSoundsFragment(UnsafeCasts.<SoundsFragment>unsafeCast(this));
    }
  }
