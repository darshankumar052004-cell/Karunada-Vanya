...
public abstract class Hilt_AlertsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AlertsFragment_GeneratedInjector) this.generatedComponent()).injectAlertsFragment(UnsafeCasts.<AlertsFragment>unsafeCast(this));
    }
  }
